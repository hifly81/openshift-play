**Examples and experiments for OpenShift**
...
- rhoar-sample-circuitbreaker:<br>
 Example from:<br>
 https://access.redhat.com/documentation/en-us/red_hat_openshift_application_runtimes/1/html-single/spring_boot_runtime_guide/index
 <br>
