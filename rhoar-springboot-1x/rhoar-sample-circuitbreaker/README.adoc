...
Open a browser pointing to the hystrix-dashboard

To use the Dashboard to monitor the MY_APP_NAME-greeting service, replace the default event stream address with the following address and click the Monitor Stream button:
